package ua.batterfly.repository;

import ua.batterfly.JhipsterSampleApplicationApp;
import ua.batterfly.config.Constants;
import ua.batterfly.config.audit.AuditEventConverter;
import ua.batterfly.domain.PersistentAuditEvent;
...
import static ua.batterfly.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
